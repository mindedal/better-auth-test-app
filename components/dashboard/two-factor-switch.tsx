    ...
    return (
      ...
      >
        <CardHeader>
          ...
          <CardDescription>Your account is secured with 2FA.</CardDescription>
        </CardHeader>
        <CardContent>
          {!showDisableConfirm ? (
            <Button
            ...
            {backupCodes.length > 0 && (
              <div className="p-4 bg-muted rounded-lg space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Save these codes in a safe place. You can use them to log in
                ...
                <div className="grid grid-cols-2 gap-2 font-mono text-sm">
                  {backupCodes.map((code, i) => (
                    <div
                      key={i}
                      className="bg-background p-1 px-2 rounded border"
                    >
                      {code}
                    </div>
                  ))}
